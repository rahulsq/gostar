...
import (
	...
	"gostar/grpc_prevention/order/pb"
...
func NewGRPCServer(endpoints Endpoints, logger log.Logger) pb.OrderServer {
...
func decodeGRPCGetByIDRequest(_ context.Context, grpcReq interface{}) (interface{}, error) {
	...
	return GetByIDRequest{ID: req.ID}, nil
}
...
func decodeGRPCGetByIDResponse(_ context.Context, grpcReply interface{}) (interface{}, error) {
	...
	return GetByIDResponse{Order: res, Err: str2err(reply.Err)}, nil
}
