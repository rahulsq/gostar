...
func MakeHandler(order Service, logger kitlog.Logger) http.Handler {
...
func decodeSumRequest(_ context.Context, r *http.Request) (request interface{}, err error) {
	...
	b1, _ := strconv.Atoi(b)
	return SumRequest{A: a1, B: b1}, nil
}
...
func encodeError(_ context.Context, err error, w http.ResponseWriter) {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	switch err {
	case ErrInvalidArgument, ErrRecordNotFound:
