...
import (
	...
	grpc "gostar/prevention/category/pkg/grpc"
...
var fs = flag.NewFlagSet("category", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "category")
...
func initGRPCHandler(endpoints endpoint.Endpoints, g *group.Group) {
	...
	g.Add(func() error {
		...
		pb.RegisterCategoryServer(baseServer, grpcServer)
