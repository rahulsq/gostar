...
//	zipkingoopentracing "github.com/openzipkin-contrib/zipkin-go-opentracing"
	...
	http "gostar/prevention/inventory/pkg/http"
...
var fs = flag.NewFlagSet("inventory", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		// recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "inventory")
