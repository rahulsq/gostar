...
import (
	...
	http "gostar/prevention/product/pkg/http"
...
var fs = flag.NewFlagSet("product", flag.ExitOnError)
...
func Run() {
	...
	//	recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "product")
